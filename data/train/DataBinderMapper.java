...
class DataBinderMapper  {
    ...
    public android.databinding.ViewDataBinding getDataBinder(android.databinding.DataBindingComponent bindingComponent, android.view.View view, int layoutId) {
        switch(layoutId) {
                case com.appradar.viper.amazingfacts.R.layout.activity_language:
                    return com.appradar.viper.amazingfacts.databinding.ActivityLanguageBinding.bind(view, bindingComponent);
                case com.heinrichreimersoftware.materialintro.R.layout.mi_fragment_simple_slide:
 {
                ...
                case com.appradar.viper.amazingfacts.R.layout.activity_splash_screen:
                    return com.appradar.viper.amazingfacts.databinding.ActivitySplashScreenBinding.bind(view, bindingComponent);
                case com.heinrichreimersoftware.materialintro.R.layout.mi_fragment_simple_slide_scrollable:
 {
    ...
    int getLayoutId(String tag) {
        ...
        switch(code) {
            case -588351020: {
                if(tag.equals("layout/activity_language_0")) {
                    return com.appradar.viper.amazingfacts.R.layout.activity_language;
                }
                break;
            }
            case 25343430: {
            ...
            case 1814340106: {
                if(tag.equals("layout/activity_splash_screen_0")) {
                    return com.appradar.viper.amazingfacts.R.layout.activity_splash_screen;
                }
                break;
            }
            case 1612553282: {
